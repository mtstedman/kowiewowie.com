(() => {
    ...
    const TAROT_SPREADS = deepFreeze([
        ...
        },
        {
            ...
            description: 'A practical three-card reading that clarifies what is happening, what stands in the way, and how best to respond.',
            grid: { rows: 1, cols: 3 },
            positions: [
                {
                    id: 'situation',
                    name: 'Situation',
                    positionMeaning: 'This position describes the heart of the matter and the energy shaping it now.',
                    readingPrompt: 'Begin here to understand what deserves your attention before deciding what to do.',
                    layout: { row: 1, col: 1, rotate: 0 },
                },
                {
                    id: 'obstacle',
                    name: 'Obstacle',
                    positionMeaning: 'This position reveals the challenge, tension, or limiting pattern complicating the situation.',
                    readingPrompt: 'Consider whether this barrier must be confronted, understood, or approached differently.',
                    layout: { row: 1, col: 2, rotate: 0 },
                },
                {
                    id: 'advice',
                    name: 'Advice',
                    positionMeaning: 'This position offers guidance for meeting the situation and its obstacle constructively.',
                    readingPrompt: 'Translate this counsel into one practical next step you can take.',
                    layout: { row: 1, col: 3, rotate: 0 },
                },
            ],
        },
        {
            id: 'decision-two-paths',
            name: 'Decision: Two Paths',
            description: 'Five cards for comparing two choices while staying grounded in your motivation, values, and desired result.',
            grid: { rows: 3, cols: 3 },
            positions: [
                {
                    id: 'motivation',
                    name: 'Motivation',
                    positionMeaning: 'This position shows what is driving the decision and why the choice matters to you.',
                    readingPrompt: 'Notice whether this motivation comes from conviction, fear, habit, or genuine desire.',
                    layout: { row: 2, col: 2, rotate: 0 },
                },
                {
                    id: 'desired-outcome',
                    name: 'Desired Outcome',
                    positionMeaning: 'This position reveals what you most hope the decision will make possible.',
                    readingPrompt: 'Use it to distinguish the result you truly want from the option you currently favor.',
                    layout: { row: 1, col: 2, rotate: 0 },
                },
                {
                    id: 'values',
                    name: 'Your Values',
                    positionMeaning: 'This position identifies the principle, need, or priority that should anchor your choice.',
                    readingPrompt: 'Ask which path lets you act most consistently with this value.',
                    layout: { row: 3, col: 2, rotate: 0 },
                },
                {
                    id: 'path-a',
                    name: 'Path A',
                    positionMeaning: 'This position shows the character and likely direction of the first option.',
                    readingPrompt: 'Consider both what this path offers and what it asks of you.',
                    layout: { row: 2, col: 1, rotate: 0 },
                },
                {
                    id: 'path-b',
                    name: 'Path B',
                    positionMeaning: 'This position shows the character and likely direction of the second option.',
                    readingPrompt: 'Compare its opportunities and demands with Path A rather than searching for a simple verdict.',
        ...
        },
        {
            ...
            description: 'A five-card view of any important relationship: what each person brings, the bond itself, its challenge, and its direction.',
            grid: { rows: 3, cols: 3 },
            positions: [
                {
                    id: 'you',
                    name: 'You',
                    positionMeaning: 'This position reflects your feelings, expectations, and role within the relationship.',
                    readingPrompt: 'Be honest about what you are contributing, seeking, or withholding.',
                    layout: { row: 2, col: 1, rotate: 0 },
                },
                {
                    id: 'other-person',
                    name: 'The Other Person',
                    positionMeaning: 'This position reflects the energy, needs, or stance the other person brings to the relationship.',
                    readingPrompt: 'Treat this as perspective for understanding the dynamic, not certainty about unspoken thoughts.',
                    layout: { row: 2, col: 3, rotate: 0 },
                },
                {
                    id: 'connection',
                    name: 'The Connection',
                    positionMeaning: 'This position describes the bond, shared pattern, or central energy between you.',
                    readingPrompt: 'Look at what joins you and what keeps this relationship active.',
                    layout: { row: 2, col: 2, rotate: 0 },
                },
                {
                    id: 'challenge',
                    name: 'The Challenge',
                    positionMeaning: 'This position shows the tension, lesson, or unmet need placing strain on the relationship.',
                    readingPrompt: 'Consider what could be named, changed, accepted, or discussed more openly.',
                    layout: { row: 3, col: 2, rotate: 0 },
                },
                {
                    id: 'direction',
                    name: 'The Direction',
                    positionMeaning: 'This position shows where the relationship is tending if its present pattern continues.',
                    readingPrompt: 'Read it as a trajectory that both people can still influence through their choices.',
                    layout: { row: 1, col: 2, rotate: 0 },
                },
            ],
        },
        {
            ...
            description: 'A concise general reading with more depth than three cards, joining the present, its influences, its challenge, and its likely outcome.',
            grid: { rows: 3, cols: 3 },
            positions: [
                {
                    id: 'present',
                    name: 'The Present',
                    positionMeaning: 'This position represents the central issue or most important energy in the matter at hand.',
                    readingPrompt: 'Let this card set the theme against which every other position is read.',
                    layout: { row: 2, col: 2, rotate: 0 },
                },
                {
                    id: 'past-influence',
                    name: 'Past Influence',
                    positionMeaning: 'This position shows an earlier event, pattern, or influence still shaping the present.',
                    readingPrompt: 'Consider what should be carried forward and what may be ready to be released.',
                    layout: { row: 2, col: 1, rotate: 0 },
                },
                {
                    id: 'conscious-mind',
                    name: 'The Conscious Mind',
                    positionMeaning: 'This position reveals your present focus, expectations, or understanding of the situation.',
                    readingPrompt: 'Notice what you are emphasizing and whether another perspective is being overlooked.',
                    layout: { row: 1, col: 2, rotate: 0 },
                },
                {
                    id: 'challenge',
                    name: 'What Crosses You',
                    positionMeaning: 'This position identifies the immediate challenge, opposition, or test affecting your path.',
                    readingPrompt: 'Ask whether this energy is blocking progress or inviting a necessary adjustment.',
                    layout: { row: 3, col: 2, rotate: 0 },
                },
                {
                    id: 'probable-outcome',
                    name: 'Probable Outcome',
                    positionMeaning: 'This position shows the direction in which the matter is most likely to develop.',
                    readingPrompt: 'Treat it as the result of the current pattern, not an outcome beyond your influence.',
                    layout: { row: 2, col: 3, rotate: 0 },
                },
            ],
        },
